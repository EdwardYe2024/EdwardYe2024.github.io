...
## 1 Kronecker product
Kronecker product is very common in tensor calculation. It is a bridge between joint matrix calculation and tensor calculation. In fact, the Kronecker product calculation rule is very simple. Given a matrix of size ![](Tensor.assets/equation.svg) and a matrix of size ![](Tensor.assets/equation-1569595360662.svg), the matrix 
